	...
	<nav class="site-nav">
		<div class="container">
			<div class="site-navigation">
				<a href="<?= base_url('')?>" class="logo m-0" style="text-decoration: none;">E-Gallery <span class="text-primary">.</span></a>

				<ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
					<li class="active"><a href="<?= base_url('')?>">Home</a></li>
					<li><a href="<?= base_url('My_Gallery')?>">My Gallery</a></li>
									...
									<div class="row mb-2">
										<div class="col-sm-12 col-md-6 mb-3 mb-lg-0 col-lg-6">
											<select name="" id="" class="form-control custom-select">
												...
												<option value="Teman & Acara Sosial">Teman & Acara Sosial</option>
